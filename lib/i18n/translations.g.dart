...
class _TranslationsIntroEn {
	...
	String get welcome_footer => 'By logging in you agree to the <a href=\'https://github.com/enrique-lozano/fintrack/blob/main/docs/PRIVACY_POLICY.md\'>Privacy Policy</a> and the <a href=\'https://github.com/enrique-lozano/fintrack/blob/main/docs/TERMS_OF_USE.md\'>Terms of Use</a> of the application';
	...
	String get last_slide_descr => 'With fintrack, you can finally achieve the financial independence you want so much. You will have graphs, budgets, tips, statistics and much more about your money.';
...
class _TranslationsHomeEn {
	...
	String get no_accounts_descr => 'Start using all the magic of fintrack. Create at least one account to start adding transactions';
...
class _TranslationsTransactionStatusEn {
	...
	String get unreconciled_descr => 'This transaction has not yet been validated and therefore does not yet appear in your real bank accounts. However, it counts for the calculation of balances and statistics in fintrack';
...
class _TranslationsBackupImportEn {
	...
	String get restore_backup_descr => 'Import a previously saved database from fintrack. This action will replace any current application data with the new data';
	String get restore_backup_warn_description => 'When importing a new database, you will lose all data currently saved in the app. It is recommended to make a backup before continuing. Do not upload here any file whose origin you do not know, upload only files that you have previously downloaded from fintrack';
...
class _TranslationsMoreAboutUsEn {
	...
	String get description => 'Check out the terms and other relevant information about fintrack. Get in touch with the community by reporting bugs, leaving suggestions...';
...
class _TranslationsMoreHelpUsEn {
	...
	String get description => 'Find out how you can help fintrack become better and better';
	String get rate_us => 'Rate us';
	String get rate_us_descr => 'Any rate is welcome!';
	String get share => 'Share fintrack';
	String get share_descr => 'Share our app to friends and family';
	String get share_text => 'fintrack! The best personal finance app. Download it here';
	String get thanks => 'Thank you!';
	String get thanks_long => 'Your contributions to fintrack and other open source projects, big and small, make great projects like this possible. Thank you for taking the time to contribute.';
...
class _TranslationsFinancialHealthReviewDescrEn {
	...
	String get very_good => 'Congratulations! Your financial health is tremendous. We hope you continue your good streak and continue learning with fintrack';
...
class _TranslationsMoreAboutUsProjectEn {
	...
	String get contributors_descr => 'All the developers who have made fintrack grow';
...
class _TranslationsIntroEs implements _TranslationsIntroEn {
	...
	@override String get welcome_footer => 'Al iniciar sesión aceptas la <a href=\'https://github.com/enrique-lozano/fintrack/blob/main/docs/PRIVACY_POLICY.md\'>Política de Privacidad</a> y los <a href=\'https://github.com/enrique-lozano/fintrack/blob/main/docs/TERMS_OF_USE.md\'>Términos de uso</a> de la aplicación';
	...
	@override String get last_slide_descr => 'Con fintrack, podrás al fin lograr la independencia financiaria que tanto deseas. Podrás ver gráficas, presupuestos, consejos, estadisticas y mucho más sobre tu dinero.';
...
class _TranslationsHomeEs implements _TranslationsHomeEn {
	...
	@override String get no_accounts_descr => 'Empieza a usar toda la magia de fintrack. Crea al menos una cuenta para empezar a añadir tranacciones';
...
class _TranslationsTransactionStatusEs implements _TranslationsTransactionStatusEn {
	...
	@override String get unreconciled_descr => 'Esta transacción aun no ha sido validada y por tanto aun no figura en sus cuentas bancarias reales. Sin embargo, es tenida en cuenta para el calculo de balances y estadisticas en fintrack';
...
class _TranslationsMoreAboutUsEs implements _TranslationsMoreAboutUsEn {
	...
	@override String get description => 'Consulta los terminos y otra información relevante sobre fintrack. Ponte en contacto con la comunidad reportando errores, dejando sugerencias...';
...
class _TranslationsMoreHelpUsEs implements _TranslationsMoreHelpUsEn {
	...
	@override String get description => 'Descubre de que formas puedes ayudar a que fintrack sea cada vez mejor';
	@override String get rate_us => 'Califícanos';
	@override String get rate_us_descr => '¡Cualquier valoración es bienvenida!';
	@override String get share => 'Comparte fintrack';
	@override String get share_descr => 'Comparte nuestra app a amigos y familiares';
	@override String get share_text => 'fintrack! La mejor app de finanzas personales. Descargala aquí';
	@override String get thanks => '¡Gracias!';
	@override String get thanks_long => 'Tus contribuciones a fintrack y otros proyectos de código abierto, grandes o pequeños, hacen posibles grandes proyectos como este. Gracias por tomarse el tiempo para contribuir.';
...
class _TranslationsFinancialHealthReviewDescrEs implements _TranslationsFinancialHealthReviewDescrEn {
	...
	@override String get very_good => 'Enhorabuena! Tu salud financiera es formidable. Esperamos que sigas con tu buena racha y que continues aprendiendo con fintrack';
...
class _TranslationsMoreAboutUsProjectEs implements _TranslationsMoreAboutUsProjectEn {
	...
	@override String get contributors_descr => 'Todos los desarrolladores que han hecho que fintrack crezca';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'intro.welcome_footer': return 'By logging in you agree to the <a href=\'https://github.com/enrique-lozano/fintrack/blob/main/docs/PRIVACY_POLICY.md\'>Privacy Policy</a> and the <a href=\'https://github.com/enrique-lozano/fintrack/blob/main/docs/TERMS_OF_USE.md\'>Terms of Use</a> of the application';
			...
			case 'intro.last_slide_descr': return 'With fintrack, you can finally achieve the financial independence you want so much. You will have graphs, budgets, tips, statistics and much more about your money.';
			...
			case 'home.no_accounts_descr': return 'Start using all the magic of fintrack. Create at least one account to start adding transactions';
			...
			case 'financial_health.review.descr.very_good': return 'Congratulations! Your financial health is tremendous. We hope you continue your good streak and continue learning with fintrack';
			...
			case 'transaction.status.unreconciled_descr': return 'This transaction has not yet been validated and therefore does not yet appear in your real bank accounts. However, it counts for the calculation of balances and statistics in fintrack';
			...
			case 'backup.import.restore_backup_descr': return 'Import a previously saved database from fintrack. This action will replace any current application data with the new data';
			...
			case 'more.about_us.description': return 'Check out the terms and other relevant information about fintrack. Get in touch with the community by reporting bugs, leaving suggestions...';
			...
			case 'more.about_us.project.contributors_descr': return 'All the developers who have made fintrack grow';
			case 'more.about_us.project.contact': return 'Contact us';
			case 'more.help_us.display': return 'Help us';
			case 'more.help_us.description': return 'Find out how you can help fintrack become better and better';
			case 'more.help_us.rate_us': return 'Rate us';
			case 'more.help_us.rate_us_descr': return 'Any rate is welcome!';
			case 'more.help_us.share': return 'Share fintrack';
			case 'more.help_us.share_descr': return 'Share our app to friends and family';
			case 'more.help_us.share_text': return 'fintrack! The best personal finance app. Download it here';
			case 'more.help_us.thanks': return 'Thank you!';
			case 'more.help_us.thanks_long': return 'Your contributions to fintrack and other open source projects, big and small, make great projects like this possible. Thank you for taking the time to contribute.';
...
extension on _TranslationsEs {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'intro.welcome_footer': return 'Al iniciar sesión aceptas la <a href=\'https://github.com/enrique-lozano/fintrack/blob/main/docs/PRIVACY_POLICY.md\'>Política de Privacidad</a> y los <a href=\'https://github.com/enrique-lozano/fintrack/blob/main/docs/TERMS_OF_USE.md\'>Términos de uso</a> de la aplicación';
			...
			case 'intro.last_slide_descr': return 'Con fintrack, podrás al fin lograr la independencia financiaria que tanto deseas. Podrás ver gráficas, presupuestos, consejos, estadisticas y mucho más sobre tu dinero.';
			...
			case 'home.no_accounts_descr': return 'Empieza a usar toda la magia de fintrack. Crea al menos una cuenta para empezar a añadir tranacciones';
			...
			case 'financial_health.review.descr.very_good': return 'Enhorabuena! Tu salud financiera es formidable. Esperamos que sigas con tu buena racha y que continues aprendiendo con fintrack';
			...
			case 'transaction.status.unreconciled_descr': return 'Esta transacción aun no ha sido validada y por tanto aun no figura en sus cuentas bancarias reales. Sin embargo, es tenida en cuenta para el calculo de balances y estadisticas en fintrack';
			...
			case 'backup.import.restore_backup_descr': return 'Importa una base de datos anteriormente guardada desde fintrack. Esta acción remplazará cualquier dato actual de la aplicación por los nuevos datos';
			...
			case 'more.about_us.description': return 'Consulta los terminos y otra información relevante sobre fintrack. Ponte en contacto con la comunidad reportando errores, dejando sugerencias...';
			...
			case 'more.about_us.project.contributors_descr': return 'Todos los desarrolladores que han hecho que fintrack crezca';
			case 'more.about_us.project.contact': return 'Contacta con nosotros';
			case 'more.help_us.display': return 'Ayúdanos';
			case 'more.help_us.description': return 'Descubre de que formas puedes ayudar a que fintrack sea cada vez mejor';
			case 'more.help_us.rate_us': return 'Califícanos';
			case 'more.help_us.rate_us_descr': return '¡Cualquier valoración es bienvenida!';
			case 'more.help_us.share': return 'Comparte fintrack';
			case 'more.help_us.share_descr': return 'Comparte nuestra app a amigos y familiares';
			case 'more.help_us.share_text': return 'fintrack! La mejor app de finanzas personales. Descargala aquí';
			case 'more.help_us.thanks': return '¡Gracias!';
			case 'more.help_us.thanks_long': return 'Tus contribuciones a fintrack y otros proyectos de código abierto, grandes o pequeños, hacen posibles grandes proyectos como este. Gracias por tomarse el tiempo para contribuir.';
