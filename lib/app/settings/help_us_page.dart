...
import 'package:fintrack/app/settings/purchases/donate_button.dart';
import 'package:fintrack/app/settings/purchases/in_app_purchase.dart';
import 'package:fintrack/app/settings/widgets/setting_card_item.dart';
import 'package:fintrack/core/utils/open_external_url.dart';
              ...
              child: Column(
                ...
                children: [
                  SettingCardItem(
                      ...
                      onTap: () {
                        openExternalURL(context,
                            'https://play.google.com/store/apps/details?id=com.fintrack.app');
                      }),
                  ...
                  SettingCardItem(
                      ...
                      onTap: () {
                        Share.share(
                            '${t.more.help_us.share_text}: https://play.google.com/store/apps/details?id=com.fintrack.app');
                      }),
                  const SizedBox(height: 8),
                  SettingCardItem(
